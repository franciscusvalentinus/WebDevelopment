    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('patent.update', $patent->id) }}">
                    @csrf
                    @method('put')
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="judul_ciptaan" id="judul_ciptaan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('judul_ciptaan', $patent->judul_ciptaan) }}" autofocus/>
                            @error('judul_ciptaan')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="date" name="tanggal_permohonan" id="tanggal_permohonan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('tanggal_permohonan', $patent->tanggal_permohonan) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nomor_efilling_f" id="nomor_efilling_f" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nomor_efilling_f', $patent->nomor_efilling_f) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nomor_efilling_s" id="nomor_efilling_s" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nomor_efilling_s', $patent->nomor_efilling_s) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="pemegang_paten" id="pemegang_paten" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('pemegang_paten', $patent->pemegang_paten) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="jenis_permohonan" id="jenis_permohonan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('jenis_permohonan', $patent->jenis_permohonan) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nomor_permohonan_f" id="nomor_permohonan_f" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nomor_permohonan_f', $patent->nomor_permohonan_f) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nomor_permohonan_s" id="nomor_permohonan_s" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nomor_permohonan_s', $patent->nomor_permohonan_s) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="jumlah_klaim" id="jumlah_klaim" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('jumlah_klaim', $patent->jumlah_klaim) }}" />
                            @error('jumlah_klaim')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_1 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_2" id="pencipta_2" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_2 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_3" id="pencipta_3" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_3 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_4" id="pencipta_4" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_4 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_5" id="pencipta_5" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_5 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_6" id="pencipta_6" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_6 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_7" id="pencipta_7" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_7 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_8" id="pencipta_8" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_8 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_9" id="pencipta_9" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_9 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_10" id="pencipta_10" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$patent->pencipta_10 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
