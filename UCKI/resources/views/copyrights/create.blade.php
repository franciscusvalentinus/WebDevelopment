                ...
                <form method="post" action="{{ route('copyright.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="pemegang_hak_cipta" id="pemengang_hak_cipta" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('pemegang_hak_cipta', '') }}" />
