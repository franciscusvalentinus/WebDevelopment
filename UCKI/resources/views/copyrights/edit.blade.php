    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('copyright.update', $copyright->id) }}">
                    @csrf
                    @method('put')
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="judul_ciptaan" id="judul_ciptaan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('judul_ciptaan', $copyright->judul_ciptaan) }}" autofocus/>
                            @error('judul_ciptaan')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="date" name="tanggal_permohonan" id="tanggal_permohonan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('tanggal_permohonan', $copyright->tanggal_permohonan) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nomor_permohonan" id="nomor_permohonan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nomor_permohonan', $copyright->nomor_permohonan) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="pemegang_hak_cipta" class="block font-medium text-sm text-gray-700">Pemegang Hak Cipta</label>
                            <input type="text" name="pemegang_hak_cipta" id="pemegang_hak_cipta" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('pemegang_hak_cipta', $copyright->pemegang_hak_cipta) }}" />
                            @error('pemegang_hak_cipta')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="nomor_pencatatan" class="block font-medium text-sm text-gray-700">Nomor Pencatatan</label>
                            <input type="text" name="nomor_pencatatan" id="nomor_pencatatan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nomor_pencatatan', $copyright->nomor_pencatatan) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="tanggal_penerimaan" class="block font-medium text-sm text-gray-700">Tanggal Penerimaan</label>
                            <input type="date" name="tanggal_penerimaan" id="tanggal_penerimaan" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('tanggal_penerimaan', $copyright->tanggal_penerimaan) }}" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="creation_id" class="block font-medium text-sm text-gray-700">Jenis Ciptaan<label class="text-red-600">*</label></label>
                            <select type="text" name="creation_id" id="creation_id" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                    value="{{ old('creation_id', '') }}">
                                <option value="option_select" disabled selected>Pilih</option>
                                @foreach ($creations as $creation)
                                    @if ($copyright->creation_id == $creation->id) {
                                    <option value="{{ $creation->id }}" selected>{{$creation->creation}}</option>
                                    }
                                    @else{
                                    <option value="{{ $creation->id }}">{{$creation->creation}}</option>
                                    }
                                    @endif
                                @endforeach
                            </select>
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_1 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_2" id="pencipta_2" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_2 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_3" id="pencipta_3" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_3 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_4" id="pencipta_4" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_4 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_5" id="pencipta_5" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_5 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_6" id="pencipta_6" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_6 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_7" id="pencipta_7" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_7 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_8" id="pencipta_8" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_8 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_9" id="pencipta_9" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_9 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select type="text" name="pencipta_10" id="pencipta_10" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                @foreach($lecturers as $lecturer)
                                    @foreach ($departments as $department)
                                        @if ($lecturer->department_id == $department->id)
                                            <option value="{{ $lecturer->id }}" {{$copyright->pencipta_10 == $lecturer->id  ? 'selected' : ''}}>{{ $lecturer->name}} ({{ $department->department }}) ({{ $lecturer->nidn }})</option>
                                        @endif
                                    @endforeach
                                @endforeach
                            </select>
